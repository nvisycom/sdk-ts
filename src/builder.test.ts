...
describe("ClientBuilder", () => {
  ...
  describe("static factory methods", () => {
    ...
    it("should validate API key in factory method", () => {
      ...
      expect(() => ClientBuilder.fromApiKey("invalid chars!")).toThrow(ConfigError);
    });
    ...
    it("should validate API key in fromConfig method", () => {
      expect(() => ClientBuilder.fromConfig({ apiKey: "short" })).toThrow(ConfigError);
      expect(() => ClientBuilder.fromConfig({ apiKey: "invalid chars!" })).toThrow(ConfigError);
    });
  });
  ...
  describe("build", () => {
    ...
    it("should build client with valid configuration", () => {
      const client = ClientBuilder.fromApiKey(validApiKey).withBaseUrl("https://custom.api.com").build();
  ...
  describe("fluent interface", () => {
    ...
    it("should support withUserAgent method", () => {
      const builder = ClientBuilder.fromApiKey(validApiKey).withUserAgent("MyCustomApp/2.0.0");
